...
def register_rh_blueprints(app):
    ...
    from modules.rh.dashboard_analitico import dashboard_analitico_rh_bp
    ...
    app.register_blueprint(dashboard_analitico_rh_bp)
    
    print("✅ Módulo de RH registrado com sucesso (Colaboradores + Estrutura + Recrutamento + Dashboard Executivo + Dashboard Analítico)")
